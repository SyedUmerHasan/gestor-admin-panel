...
<script>
    $(document).ready(function() { 
        ...
        const my_url = "http://127.0.0.1:8000/api/income/"+id;
        $('#table_id').DataTable( {
            "ajax": {
                "url": my_url,
                "type": "POST",
            ...
            "columns": [
                ...
                { "title": "Day", "data": "data.day" ,"defaultContent": "<i>-</i>"},
                { "title": "Date", "data": "data.date" ,"defaultContent": "<i>-</i>"},
                { "title": "Month", "data": "data.month" ,"defaultContent": "<i>-</i>"},
                { "title": "Year", "data": "data.year" ,"defaultContent": "<i>-</i>"},
                { "title": "Details", "data": "id" ,"render": function ( data, type, row, meta ) {
                    return '<a class="btn btn-info" style="margin-right:5px;" href="/user/' + id+ '/income/view/' + data + '" role="button">Details</a>';
                  }
                },
            ]
        } );    
