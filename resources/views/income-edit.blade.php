    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <span class="clearfix">
                ...
                <a style="margin: 0px 5px;"  class="btn btn-info float-right" href="{{ route('income.view', [$userid, $incomeid]) }}" role="button"> View income</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-inverse" style="">
                                <thead class="thead-inverse">
                                    ...
                                    <tbody>
                                        <form action="{{ route('income.update', [$userid, $incomeid]) }}" method="get">
                                            @csrf
                                            <tr>
